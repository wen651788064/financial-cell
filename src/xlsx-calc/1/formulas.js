...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    /******/([
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            exports._XLFN = set(exports.COVARIANCE)
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var evalExpression = __webpack_require__(19);
            ...
            exports.NOW = function () {
                ...
                // return year+ '/' + month + '/' + day + ' ' + hour + ':' + s;2019-10-9
            ...
            // exports.MODEMULT = function () {
            //     var Formulas = require("js-spreadsheet").AllFormulas;
            //     return Formulas.MODE.MODEMULT();
            // };
            ...
            // TODO
            exports.ROMAN = function (number, form) {
                number = utils.parseNumber(number);
                form = utils.parseNumber(form);
                if (number instanceof Error) {
                    return number;
                }
            ...
            exports.SUMIF = function (range, criteria, sum_range) {
                ...
                for (var i = 0; i < range.length; i++) {
                    ...
                    if (isWildcard) {
                        ...
                        result += (evalExpression.compute(tokens) ? sum_value : 0);
                    }
                }
        ...
        // }{
            //XW: 判断参数类型
           exports.checkType = function(param, type_list, error_return){
                for (var i=0; i<type_list; i++){
                    if (typeof param === type_list[i]){
                        return true
                    }
                }
                return error_return
            ...
            exports.MPRICE = function () {
                if (!arguments[1] || arguments[0] === 0) {
                    return find(arguments[0], lianjia);
                } else if (arguments[1] === 1) {
                    return find(arguments[0], woaiwojia);
                } else if (arguments[1] === 2) {
                    return find(arguments[0], fangtianxia, false);
                }
            }
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            exports.BETA.DIST = function (x, alpha, beta, cumulative, A, B) {
                ...
                if(cumulative != undefined && !(cumulative == 'FALSE' || cumulative == 'TRUE')){
                    return error.value
                }
                if (cumulative == 'FALSE') {
                    cumulative = false
            ...
            exports.COVARIANCE.P = function (array1, array2) {
                ...
                array1 = utils.flatten(array1);
                array2 = utils.flatten(array2);
                if (utils.anyIsError(array1, array2)) {
                    return error.value;
                }
            ...
            exports.LINEST = function (data_y, data_x) {
                var Formulas = require("js-spreadsheet").AllFormulas;
                return Formulas.LINEST(data_y, data_x);
                // data_y = utils.flatten(data_y);
                // data_x = utils.flatten(data_x);
            ...
            exports.MAXA = function () {
                ...
                if (utils.anyIsError(range)) {
                    return error.value;
                }
                return (range.length === 0) ? 0 : Math.max.apply(Math, range);
            };
            exports.MEDIAN = function () {
                var arr = utils.flatten(arguments)
                var arr2 = []
                ...
                var range = utils.arrayValuesToNumbers(arr2);
            ...
            // exports.PERCENTILE = {};
            exports.PERCENTILE = function percentile(arr, k) {
                var _arr = arr.sort()
            ...
            exports.VAR.S = function () {
                ...
                return isNaN(sigma / (n - 1))?error.value:sigma / (n - 1);
            };
            ...
            exports.VARA = function () {
                ...
                return isNaN(sigma / (count - 1))?error.value:sigma / (count - 1);
            };
            ...
            exports.VARPA = function () {
                ...
                return isNaN(sigma / count)?error.value:sigma / count;
            };
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            exports.USDOLLAR = function (number, decimals) {
                decimals = (decimals === undefined) ? 2 : decimals;
            ...
            exports.PROPER = function (text) {
                ...
                return text.toLowerCase().replace(/\b([\w|']+)\b/g, function(word) {
                    char_idx = 0
                    ...
                    return word.replace(word.charAt(char_idx), word.charAt(char_idx).toUpperCase());
                });
            };
            ...
            //todo 读取""""时会自动转成undefined，无法判定
            exports.SEARCH = function (find_text, within_text, position) {
                var foundAt;
                if (find_text == undefined){
                    find_text = '"'
                }
            ...
            exports.UNICHAR = function (text) {
                ...
                console.log(String.fromCharCode(text))
            ...
            exports.VALUE = function (text) {
                ...
                if (text.match(/^(\d{1,2}):(\d{1,2}):(\d{1,2})$/)){
                    return numeral().unformat(text) / 86400
                }
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var utils = __webpack_require__(4);
            // TODO
            exports.CELL = function (type, value) {
                switch (type){
                    case 'ROW':
                        return 107//cell的行数
                    case 'CONTENTS':
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            exports.IMPRODUCT = function (inumber) {
                inumber = trans_num(inumber)
                // Initialize result
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            exports.DATEVALUE = function (date_text) {
                ...
                return Math.round((date - d1900) / 86400000 + 2);
            };
            ...
            exports.EDATE = function (start_date, months) {
                ...
                return parseInt(serial(start_date));
            };
            ...
            //todo
            exports.HYPERLINK = function (link_location, friendly_name) {
            ...
            exports.NETWORKDAYSINTL = function (start_date, end_date, weekend, holidays) {
                ...
                try{
                    ...
                    start_date = ExcelDateToJSDate(utils.parseDate(start_date));
                    end_date = ExcelDateToJSDate(utils.parseDate(end_date));
                    if (start_date instanceof Error) {
                        return start_date;
                    }
                    if (end_date instanceof Error) {
            ...
            exports.NETWORKDAYS.INTL = function (start_date, end_date, weekend, holidays) {
                ...
                end_date = ExcelDateToJSDate(end_date);
                if (start_date instanceof Error) {
                    return start_date;
                }
                if (end_date instanceof Error) {
            ...
            exports.NORMSDIST = function(z, cumulative) {
                if (cumulative == undefined){
                    cumulative = true
                }
                if(typeof cumulative == 'string' && !(cumulative == 'FALSE' || cumulative == 'TRUE')){
            ...
            exports.SECOND = function (serial_number) {
                var Formulas = require("js-spreadsheet").AllFormulas;
                try{
                    var result = Formulas.SECOND(serial_number);
                    return result
                }catch(e){
                    return error.value
                }
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            exports.IFNA = function (value, value_if_na) {
                return (value === error.na || value === '#N/A') ? value_if_na : value;
            };
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            exports.ACCRINT = function (issue, first, settlement, rate, par, frequency, basis) {
                ...
                //XW: 参数错误报错
                try{
                    issue = ExcelDateToJSDate(issue);
                    first = ExcelDateToJSDate(first);
                    settlement = ExcelDateToJSDate(settlement);
                }catch (e) {
                    return error.value;
                }
                //XW：end
            ...
            exports.DB = function (cost, salvage, life, period, month) {
              ...
              //XW: checktype 函数用例
                utils.checkType(cost, ['number'], error.value)
              // var cost_valid = utils.checkType(cost, ['number'], error.value)
              // if (cost_valid !== 'yes'){
              //     return cost_valid
              // }
              var salvage_valid = utils.checkType(salvage, ['number'], error.value)
              if (salvage_valid != 'yes'){
                  return salvage_valid
              }
              var life_valid = utils.checkType(life, ['number'], error.value)
              if (life_valid != 'yes'){
                  return life_valid
              }
              var period_valid = utils.checkType(period, ['number'], error.value)
              if (period_valid != 'yes'){
                  return period_valid
              }
              var month_valid = utils.checkType(month, ['number'], error.value)
              if (month_valid != 'yes'){
                  return month_valid
              }
              //XW：end
            ...
            function  argsToArray(arguments){
                ...
                var arr = []
                for (var i=1; i < arguments.length; i++){
                    var num = arguments[i].toString().replace('{', '').replace('}', '')
                    if (num.indexOf(';') > 0) {
                        arr.push(parseFloat(num.split(';')[0]))
                        matrix.push(arr)
                        arr = [parseFloat(num.split(';')[1])]
                    }else{
            ...
            exports.FVSCHEDULE = function (principal, schedule) {
                ...
                if (typeof schedule == 'string'){
                    schedule = argsToArray(arguments)
                }
            ...
            exports.MIRR = function (values, finance_rate, reinvest_rate) {
                ...
                var result =  Math.pow(num / den, 1 / (n - 1)) - 1;
            ...
            // TODO
            exports.ODDFYIELD = function (settlement, maturity, rate, pr, redemption, frequency, basis) {
                var a = 1
                return ''
            };
            ...
            exports.PV = function (rate, periods, payment, future, type) {
                ...
                // var a = finance.(cost, date_purchased, first_period, salvage, period, rate, basis);
                future = future || 0;
                type = type || 0;
            ...
            exports.TBILLYIELD = function (settlement, maturity, price) {
                ...
                // Return bond-equivalent yield
                return Math.abs((100 - price) * 360 / (price * dateTime.DAYS(settlement, maturity, false)));
            };
            ...
            // TODO
            exports.YIELDMAT = function (settlement,maturity,issue,rate,pr,basis) {
